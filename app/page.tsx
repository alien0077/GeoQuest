...
export default function Home() {
  ...
  const studyHighlightNames = studyMode === "country"
    ...
    : studyMode === "allies" && studyMapCountry ? [studyMapCountry.mapName] : [];
